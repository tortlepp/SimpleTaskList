 ...
 *
 *
 * Notice by Thorsten Ortlepp:
 * This is a fixed version of the original SortedList from JavaFX / JDK
 *
 * In the original SortedLIst sometimes an ArrayIndexOutOfBoundsException occurs when
 * a list item was changed and then items where removed from the list. The lines
 * 319 - 328 were added to prevent this exception. The original workaround was created
 * by David Gilbert. For details about this bug see ticket JDK-8087508:
 * https://bugs.openjdk.java.net/browse/JDK-8087508
 *
 *
 *
 *
...
package eu.ortlepp.tasklist.extra;
 ...
 * @since JavaFX 8.0
 */
public final class CustomSortedList<E> extends TransformationList<E, E>{
     ...
     */
    public CustomSortedList(@NamedArg("source") ObservableList<? extends E> source) {
